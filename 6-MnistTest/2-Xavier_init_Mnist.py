...
W2 = tf.get_variable("W2",shape=[784,default_node_size],initializer=xavier_init[default_node_size,default_node_size])
W3 = tf.get_variable("W3",shape=[784,default_node_size],initializer=xavier_init[default_node_size,10])
